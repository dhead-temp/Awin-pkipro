    ...
    <main>
      ...
      <div class="progress-container">
                ...
                <div class="lower-btns">
                    ...
                    <button href="#" class="whatsAppBtn r-flex ali-c jut-c " id="share-button" onclick="gtag('event', 'invite_on_result');">
                    ...
                    <button href="#" class="payUPIbtn r-flex ali-c jut-c " id="next-button" onclick="window.location.href = 'details.php';" disabled onclick="gtag('event', 'proceed_from_result');">
                        <span>Proceed</span>
