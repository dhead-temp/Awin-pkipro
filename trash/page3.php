...
<body>
        ...
        <div class="container ">
            ...
            <div class="main-container-box">
                ...
                <div class="hero-container-box">
                    ...
                    <div class="hero-head4">7/100</div>
                ...
                <div class="lower-btns">
                    ...
                    <button class="whatsAppBtn r-flex ali-c jut-c " id="share-button">
                    ...
                    <button class="appDownlodBtn r-flex ali-c jut-c " id="next-button" disabled>
    ...
    <script>
        ...
        shareButton.addEventListener("click", () => {
          shareCount++;
          progressBar.style.width = `${shareCount * 33.33}%`; // 33.33% represents one-third of the progress bar width
