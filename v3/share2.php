...
?>  
            <div class="main-container-box">
                ...
                <div class="lower-btns">
                    ...
                    <button class="whatsAppBtn r-flex ali-c jut-c btneffectfont " id="share-button" onclick="gtag('event', 'invite_on_share2');">
                    ...
                    <button class="appDownlodBtn r-flex ali-c jut-c btneffectfont " id="download-button" onclick="gtag('event', 'download_app');">
                    ...
                    <br><br>
                    <button href="#" class="payUPIbtn r-flex ali-c jut-c btneffectfont " id="next-button" onclick="window.location.href = '#';" disabled  onclick="gtag('event', 'claim_prize');">
